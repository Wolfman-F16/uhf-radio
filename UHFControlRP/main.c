...
/*
 * bugs:
 * 1) on power up, op mode is displayed with offset of 2 "R/OP  "
 * 2) indicator board not waiting for comm before going self test
 */
/*
 * 1) seems to be related to eeprom not loaded correctly on uC
 * 2) off works, on does not (uhf is reported as off?)
 */
