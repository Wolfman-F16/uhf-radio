 ...
 * the implications!
 */
#define  USB_CFG_DEVICE_ID       0x7D, 0x02 /* = 0x027D = 10203 */
 ...
 */
#define USB_CFG_VENDOR_NAME     'v', 'o', 't', 'i','.', 'n', 'l'
 ...
 * details.
 */
#define USB_CFG_DEVICE_NAME     'S', 'I', 'M', 'K', 'e', 'y'
#define USB_CFG_DEVICE_NAME_LEN 6
/* Same as above for the device name. If you don't want a device name, undefine
 * the macros. See the file USB-IDs-for-free.txt before you assign a name if
 * you use a shared VID/PID.
 */
#define USB_CFG_SERIAL_NUMBER   '1', '.', '1', '.', '0'
...
#define USB_CFG_INTERFACE_SUBCLASS  1   /* boot device*/
