...
/*  04 */ {MOD_SHIFT_LEFT | MOD_ALT_LEFT | MOD_CTRL_LEFT, KEY_Z},       // mode adf
...
/*  42 */ {MOD_SHIFT_LEFT | MOD_CTRL_LEFT               , KEY_DOT},     // Freq 4 9
/*  43 */ {MOD_SHIFT_LEFT | MOD_ALT_LEFT                , KEY_DOT},     // Freq 5 00
/*  44 */ {MOD_ALT_LEFT | MOD_CTRL_LEFT                 , KEY_DOT},     // Freq 5 25
/*  45 */ {MOD_SHIFT_LEFT | MOD_ALT_LEFT | MOD_CTRL_LEFT, KEY_DOT},     // Freq 5 50
/*  46 */ {MOD_SHIFT_LEFT | MOD_CTRL_LEFT               , KEY_S},       // Freq 5 75
/*  47 */ {MOD_SHIFT_LEFT | MOD_CTRL_LEFT               , KEY_ENTER},   // Load
...
/*  55 */ {MOD_SHIFT_LEFT | MOD_CTRL_LEFT               , KEY_S},       // Chan Vol Inc
/*  56 */ {MOD_ALT_LEFT | MOD_CTRL_LEFT                 , KEY_S},       // Chan Vol Dec
/*  57 */ {MOD_SHIFT_LEFT | MOD_ALT_LEFT                , KEY_S}        // Test Display
          /* TODO channel does not support discrete signaling */
};
